...
class NotificationOnKillService : Service() {
    ...
    companion object {
        private const val NOTIFICATION_ID = 86668
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        ...
        try {
            ...
            val descriptionText =
                "If an alarm was set and the app is killed, " +
                    "a notification will show to warn the user " +
                    "the alarm could not ring as long as the app is killed"
