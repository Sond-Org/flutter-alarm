...
class VolumeHandler(private val context: Context) {
    ...
    fun setVolume(
        ...
        val volumeValue = (round(volume * maxVolume)).toInt()
        audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, volumeValue, if (showSystemUI) AudioManager.FLAG_SHOW_UI else 0)
    }
